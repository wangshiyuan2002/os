...
extern int sys_execve2(const char *path, char * argv[], char * envp[]);
extern int sys_getdents(unsigned int fd, struct linux_dirent *dirp, unsigned int count);
extern int sys_sleep(unsigned int seconds);
